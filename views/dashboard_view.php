                        ...
                        <div class="row match-height">
                            ...
                            <div class="col-xl-4 col-md-6 col-12">
                                <div class="card card-congratulation-medal">
                                    <div class="card-body">
                                        <h5>Encaissement</h5>
                                        <p class="card-text font-small-3"> <?= $moisActuel; ?> </p>
                                        <h3 class="mb-75 mt-2 pt-50">
                                            <a href="#"> <?= $montant_total_payer_mois_en_cours; ?> FCFA</a>
                                        </h3>
                                        <button type="button" class="btn btn-primary">Voir le journal</button>
                                        <img src="assets/images/template/badge.svg" class="congratulation-medal" alt="Medal Pic" />
                                    </div>
                                </div>
                            </div>
                            <!--/ Medal Card -->
                                        ...
                                        <div class="row">
                                            <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                                                <div class="d-flex flex-row">
                                                    ...
                                                    <div class="my-auto">
                                                        <h4 class="fw-bolder mb-0"><?= $nbre_batiment; ?></h4>
                                                        <p class="card-text font-small-3 mb-0">Batiments</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                                                <div class="d-flex flex-row">
                                                    ...
                                                    <div class="my-auto">
                                                        <h4 class="fw-bolder mb-0"><?= $nbre_appartement; ?></h4>
                                                        <p class="card-text font-small-3 mb-0">Appartements</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-sm-0">
                                                <div class="d-flex flex-row">
                                                    ...
                                                    <div class="my-auto">
                                                        <h4 class="fw-bolder mb-0"><?= $nbre_locataire; ?></h4>
                                                        <p class="card-text font-small-3 mb-0">Locataires</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-sm-6 col-12">
                                                <div class="d-flex flex-row">
                                                    ...
                                                    <div class="my-auto">
                                                        <h4 class="fw-bolder mb-0"><?= $nbre_proprietaire; ?></h4>
                                                        <p class="card-text font-small-3 mb-0">Propriétaires</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-12 col-md-6 col-12">
                                        <div class="card earnings-card">
                                            <div class="dropdown-item mb-1">
                                                <select class="form-control form-control-sm" id="MoisGraph" name="MoisGraph" tabindex="3" required>
                                                <option value="<?= $mois; ?>" selected><?= $moisEnFrancais[$mois]; ?></option>
                                                    <?php
                                                    foreach ($moisEnFrancais as $cle  => $valeur) {
                                                    ?>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <h4 class="card-title mb-1">Loyer Payer/Impayés</h4>
                                                        <div class="font-small-2">Payé</div>
                                                        <h5 class="mb-1" id="PayerMoisChoisi"><?= $montant_total_payer_mois_en_cours; ?> FCFA</h5>

                                                        <div class="font-small-2">Impayé</div>
                                                        <h5 class="mb-1" id="ImpayerMoisChoisi"><?= $montant_total_reste_mois_en_cours; ?> FCFA</h5>
                                    ...
                                    <div class="row mx-0">
                                        <div class="col-md-8 col-12 revenue-report-wrapper">
                                            <div class="d-sm-flex justify-content-between align-items-center mb-3">
                                                <h4 class="card-title mb-50 mb-sm-0">Recouvrement de l'année en cours</h4>
                                                <div class="d-flex align-items-center">
