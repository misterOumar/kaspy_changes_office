        ...
        <div class="content-wrapper container-xxl p-0">
            <div class="content-header row">
                ...
                <div class="my-3 p-3 bg-body rounded shadow-sm" style="color: white">
                    ...
                    <div class="majuscules">Heure et date : <span style="text-transform:lowercase; color:black; font-weight:bolder;" id="Heure_et_date"><?=$_GET['Heure_et_date']?></span></div>
                    <div class="majuscules">Num_Ref : <span style="text-transform:lowercase; color:black; font-weight:bolder;" id="Num_Ref"><?=$_GET['Num_Ref']?></span></div>
                    <div class="majuscules">Identifiant de l'utilisateur : <span id="Identifiant_utilisateur"><?=$_GET['Identifiant_utilisateur']?></span>
                    </div>
                    <div class="majuscules">ID du point de vente : <span style="text-transform:lowercase; color:black; font-weight:bolder;" id="ID_point_vente"><?=$_GET['ID_point_vente']?></span></div>
                    <div class="majuscules">Montant : <span style="text-transform:lowercase; color:black; font-weight:bolder;" id="Montant"><?=$_GET['Montant']?></span></div>
                    <div class="majuscules">Frais : <span style="text-transform:lowercase; color:black; font-weight:bolder;" id="Frais"><?=$_GET['Frais']?></span></div>
                    <div class="majuscules">Total : <span style="text-transform:lowercase; color:black; font-weight:bolder;" id="Total"><?=$_GET['Total']?></span></div>
                    <div class="majuscules">ajouter par : <span style="text-transform:lowercase; color:black; font-weight:bolder;" id="ajouter_par"><?=$_GET['ajouter_par']?></span></div>
                </div>
                <div class="my-3 p-3 bg-body rounded shadow-sm" style="color: white">
