        ...
        <div class="content-wrapper container-xxl p-0">
            <div class="content-header row">
                ...
                <div class="my-3 p-3 bg-body rounded shadow-sm" style="color: white">
                    ...
                    <div class="majuscules">dates : <span style="text-transform:lowercase; color:black; font-weight:bolder;" id="Heure_et_date"><?=$_GET['dates']?></span></div>
                    <div class="majuscules">elements : <span style="text-transform:lowercase; color:black; font-weight:bolder;" id="Num_Ref"><?=$_GET['elements']?></span></div>
                    <div class="majuscules">achats : <span id="Identifiant_utilisateur"><?=$_GET['achats']?></span></div>

                    <div class="majuscules">taux : <span style="text-transform:lowercase; color:black; font-weight:bolder;" id="ID_point_vente"><?=$_GET['taux']?></span></div>
                    <div class="majuscules">total : <span style="text-transform:lowercase; color:black; font-weight:bolder;" id="Montant"><?=$_GET['total']?></span></div>
                    <div class="majuscules">elements 1 : <span style="text-transform:lowercase; color:black; font-weight:bolder;" id="Frais"><?=$_GET['elements_1']?></span></div>
                    <div class="majuscules">ventes : <span style="text-transform:lowercase; color:black; font-weight:bolder;" id="Total"><?=$_GET['ventes']?></span></div>
                    <div class="majuscules">taux 2 : <span style="text-transform:lowercase; color:black; font-weight:bolder;" id="ajouter_par"><?=$_GET['taux_2']?></span></div>
                    <div class="majuscules">total 3 : <span style="text-transform:lowercase; color:black; font-weight:bolder;" id="ajouter_par"><?=$_GET['total_3']?></span></div>
                    <div class="majuscules">commission : <span style="text-transform:lowercase; color:black; font-weight:bolder;" id="ajouter_par"><?=$_GET['commission']?></span></div>
                    <div class="majuscules">montant : <span style="text-transform:lowercase; color:black; font-weight:bolder;" id="ajouter_par"><?=$_GET['montant']?></span></div>
                    <div class="majuscules">total cms : <span style="text-transform:lowercase; color:black; font-weight:bolder;" id="ajouter_par"><?=$_GET['total_cms']?></span></div>
