    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <?php if (intval($_SESSION['KaspyISS_user_details'][11]['lecture']) === 1) { ?>
                <li class="<?= $_GET['page'] === 'uba' ? "active" : ($_GET['page'] === 'rechargement_uba' ? "active" : "") ?>">
                    <a class="d-flex align-items-center" href="index.php?page=rechargement_uba"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);">
                            <path d="M20 4H4c-1.103 0-2 .897-2 2v12c0 1.103.897 2 2 2h16c1.103 0 2-.897 2-2V6c0-1.103-.897-2-2-2zm-7.5 12a2.5 2.5 0 1 1 0-5 2.47 2.47 0 0 1 1.5.512c-.604.456-1 1.173-1 1.988s.396 1.532 1 1.988a2.47 2.47 0 0 1-1.5.512zm4 0a2.5 2.5 0 1 1 0-5 2.5 2.5 0 0 1 0 5z">
                            </path>
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><svg xmlns="http://www.w3.org/2000/svg" height="16" width="18" viewBox="0 0 576 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2023 Fonticons, Inc.-->
                    ...
                    <ul class="menu-content">
                        <?php if (intval($_SESSION['KaspyISS_user_details'][9]['lecture']) === 1) { ?>
                            <li class="<?= $_GET['page'] === 'vente_carte' ? "active" : "" ?>"><a class="d-flex align-items-center" href="index.php?page=vente_carte"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Edit">Vente
                                        de carte</span></a>
                            </li>
                        <?php
                        }; ?>
            ...
            <?php if (intval($_SESSION['KaspyISS_user_details'][15]['lecture']) === 1 || intval($_SESSION['KaspyISS_user_details'][16]['lecture']) === 1 || intval($_SESSION['KaspyISS_user_details'][17]['lecture']) === 1) { ?>
