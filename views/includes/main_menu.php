...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="<?= $_GET['page'] === 'uba' ? "active" : ($_GET['page'] === 'rechargement_uba' ? "active" : "") ?>"><a class="d-flex align-items-center" href="index.php?page=rechargement_uba"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;">
