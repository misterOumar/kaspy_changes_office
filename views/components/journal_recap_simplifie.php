...
<div class="modal fade" id="JournalRecapSimpliflie" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body px-2 pb-2">
                <div class="text-center mb-2">
                    <h4 class="role-title">Récapitulatif simplifié des transferts</h4>
                    <p>Previsualisation</p>
                </div>
                <!-- Add role form -->
                <form id="form_recap_simplifie" name="form_recap_simplifie" class="row" action="etats/EtatListeAllTransfert.php" method="POST">
                    ...
                    <div class="col-12 text-center mt-2">
                        <button type="submit" class="btn btn-primary me-1" id="bt_recap_simplifie" name="bt_recap_simplifie">Visualiser</button>
