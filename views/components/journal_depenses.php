...
<div class="modal fade" id="JournalDepenses" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body px-2 pb-2">
                <div class="text-center mb-2">
                    <h4 class="role-title">Journal des Dépenses</h4>
                    <p>Previsualisation</p>
                </div>
                <!-- Add role form -->
                <form id="form_orange" name="form_orange" class="row" action="etats/EtatListeDepenses.php" method="POST">
                    ...
                    <div class="col-12 text-center mt-2">
                        <button type="submit" class="btn btn-primary me-1" id="bt_depenses" name="bt_depenses">Visualiser</button>
