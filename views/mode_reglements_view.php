...
<head>
    <title><?= APP_NAME ?> - Mode de règlement</title>
...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="">
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Mode de règlement
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <section id="basic-datatable">
                    ...
                    <div class="modal modal-slide-in fade" id="modals-slide-in">
                        <div class="modal-dialog sidebar-sm">
                            <form id="form_ajouter" name="form_ajouter" class="add-new-record modal-content pt-0" action="controllers/mode_reglements_controller.php" method="POST">

                                <button type="button" class="btn-close" data-bs-disminomss="modal" aria-label="Close">×</button>
                                <div class="modal-header mb-1">
                                    <h5 class="modal-title" id="exampleModalLabel">Création d'un nouveau mode de règlements</h5>
                                </div>
                                ...
                                <div class="modal-body flex-grow-1">
                                    <!--- NOM --->
                                    <div class='mb-1'>
                                        <label class='form-label' for='nom'>Nom du mode de règlements </label>
                                        <input type='text' class='form-control dt-full-nom' id='nom' name='nom' placeholder='Veuillez saisir le nom du mode de règlement' aria - Label='nom' maxlength='75' />
                                    </div>
                    ...
                    <div class="modal modal-slide-in fade" id="modal-modifier">
                        <div class="modal-dialog sidebar-sm">
                            <form id="form_modifier" name="form_modifier" class="add-new-record modal-content pt-0" action="controllers/mode_reglements_controller.php" method="POST">

                                <button type="button" class="btn-close" data-bs-disminomss="modal" aria-label="Close">×</button>
                                <div class="modal-header mb-1">
                                    <h5 class="modal-title" id="exampleModalLabel">Modification d'un  mode de règlement</h5>
                                </div>
                                <button type="button" id="bt_vider" name="bt_vider" class="btn" data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="bottom" class="avatar pull-up my-0" title="Vider les champs" style=" position: relative; height: 30px; width:30px; left: 300pX; padding:5px; margin-top:-10px;">
                                    <i data-feather='refresh-ccw'></i></button>
                                ...
                                <div class="modal-body flex-grow-1">
                                    <!--- NOM --->
                                    <div class='mb-1'>
                                        <label class='form-label' for='nom_modif'>Nom du mode de règlements </label>
                                        <input type='text' class='form-control dt-full-nom' id='nom_modif' name='nom_modif' placeholder='Veuillez saisir le nom du mode de règlement' aria - Label='nom' maxlength='75' />
                                    </div>
                                    <div class='mb-1'><small id='nom_modifHelp' class='text-danger invisible'></small></div>
    ...
    <?php include 'js/logiques/mode_reglements_datatable.php' ?>
    <?php include 'js/logiques/mode_reglements_logiques.php' ?>
