...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static " data-open="click" data-menu="vertical-menu-modern" data-col="">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Transactions orange Money</h2>
                ...
                <section id="basic-datatable">
                    ...
                    <div class="modal modal-slide-in fade" id="modals-slide-in">
                        <div class="modal-dialog sidebar-sm">
                            <form id="form_ajouter" name="form_ajouter" class="add-new-record modal-content pt-0" action="controllers/orange_money_controller.php" method="POST">
                                ...
                                <div class="modal-body flex-grow-1">
                                    ...
                                    <div>
                                        ...
                                        <input type='text' class='form-control dt-full-etablie_le' id='date_t' name='date_t'/>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type='tel' value="07" class='form-control dt-full-compte_contribuable' id='tel_cli' name='tel_cli' />
                                    </div>
    ...
    <!-- <?php include 'js/flatpick_fr.js' ?>
     -->
    <?php include 'js/logiques/orange_money_datatable.php' ?>
    <?php include 'js/logiques/orange_money_logiques.php' ?>
    <?php include 'js/logiques/reporting_logiques.php' ?>
    <?php include 'js/logiques/orange_modal_logiques.php' ?>
