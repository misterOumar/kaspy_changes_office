                        ...
                        <div class="modal-dialog sidebar-sm">
                            <form id="form_ajouter" name="form_ajouter" class="add-new-record modal-content pt-0" action="controllers/orange_money_controller.php" method="POST">
                                ...
                                <div class="modal-header mb-1">
                                    <h5 class="modal-title" id="exampleModalLabel">Enregistrement d'une nouvelle transaction orange money</h5>
                                </div>
                                ...
                                <div class="modal-body flex-grow-1">
                                    ...
                                    <div class="modal-body flex-grow-1">
                                        ...
                                        <!--- ENREGISTREMENT --->
                                        <button type="submit" id='bt_enregistrer' name='bt_enregistrer' class='btn btn-primary enregistrer me-2'>Enregistrer</button>
