                                ...
                                <form id="form_modif" name="form_modif" class="add-new-record modal-content pt-0" action="controllers/orange_money_controller.php" method="POST">
                                    ...
                                    <div class="modal-body flex-grow-1">
                                        ...
                                        <div>
                                            ...
                                            <input type='text' class='form-control dt-full-domicile' id='date_t_modif' name='date_t_modif' placeholder='Nom complet du locataire' aria - Label='domicile_modif' maxlength='75' />
                                        </div>
