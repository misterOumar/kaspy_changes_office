                             ...
                             <form id="form_ajouter" name="form_ajouter" class="add-new-record modal-content pt-0" action="controllers/annees_controller.php" method="POST">
                                 ...
                                 <div class="modal-body flex-grow-1">
                                     ...
                                     <div class='mb-1'>
                                         ...
                                         <input type='text' id='date_activation' class='form-control dt-full-date_fin flatpickr-basic' name='date_activation' placeholder="YYYY-MM-DD" aria - Label='date_fin' maxlength='75' />
                                     </div>
                                     <div class='mb-1'><small id='date_activationHelp' class='text-danger invisible'></small></div>
                                     <!--- DATE DEBUT --->
                                     <div class='mb-1'>
                                     ...
                                     <div class='mb-1'>
                                         ...
                                         <select name='type' id='type' data-placeholder="Choisir le contrat de bail..." Class='select2-icons form-select'>
