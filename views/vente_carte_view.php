                          ...
                          <div class="modal-dialog sidebar-sm">
                              <form id="form_ajouter" name="form_ajouter" class="add-new-record modal-content pt-0" action="controllers/vente_carte_controller.php" method="POST">
                                  ...
                                  <div class="modal-body flex-grow-1">
                                      ...
                                      <div>
                                          <label class='form-label' for='contrat_bail'>Choisir la numero</label>
                                          <select name='num_carte' id='num_carte' data-placeholder="Choisir le numero de la  carte..." Class='select2-icons form-select'>
                                              <option selected data-icon='facebook'>Choisir la numero</Option>
                                              <?php
                                                foreach ($List_cartes as $cartes) {
                                                ?>
