    ...
    <head>
        <title>Vente des dévises - <?= APP_NAME ?> </title>
    ...
    <body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="">
                ...
                <div class="content-header row">
                    <div class="content-header-left col-md-9 col-12 mb-2">
                        <div class="row breadcrumbs-top">
                            <div class="col-12">
                                <h2 class="content-header-title float-start mb-0">Gestion des ventes de dévise</h2>
                                <div class="breadcrumb-wrapper">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active">ventes de dévise
                                        </li>
                                    </ol>
                                </div>
                            </div>
                            ...
                            <div class="modal-dialog sidebar" style="width: 40%;">
                                <div class="add-new-record modal-content pt-0">
                                    ...
                                    <div class="modal-header mb-1">
                                        <h5 class="modal-title" id="exampleModalLabel">Enregistrement d'une vente de dévise</h5>
                                    </div>
                                                ...
                                                <div class="bs-stepper-content">
                                                    ...
                                                    <div id="social-links-modern" class="content" role="tabpanel" aria-labelledby="social-links-modern-trigger">
                                                        ...
                                                        <form id="form_facturation" name="form_facturation">
                                                            ...
                                                            <!--- DATE --->
                                                            <div class="mb-1">
                                                                <label class='form-label' for='date_vente'>Date</label>
                                                                <input type='text' class='form-control' id='date_vente' name='date_vente' />
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div>
                                                                        <label class='form-label' for='taux_vente'>Taux à la vente</label>
                                                                        <input type='text' class='form-control' id='taux_vente' name='taux_vente' placeholder="650" maxlength='75' />
                                                                    </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div>
                                                                        ...
                                                                        <input type='text' class='form-control bg-light-info' id='total_brut' name='total_brut' placeholder="650" maxlength='75' />
                                                                    </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div>
                                                                        ...
                                                                        <input type='text' class='form-control bg-light-info' id='total_net' name='total_net' placeholder="650" maxlength='75' />
                                                                    </div>
                        ...
                        <div class="modal modal-slide-in fade" id="modal-modif">
                            <div class="modal-dialog sidebar" style="width: 40%;">
                                <div class="add-new-record modal-content pt-0">
                                    ...
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">×</button>
                                    <div class="modal-header mb-1">
                                        <h5 class="modal-title" id="exampleModalLabelModif">Modification de la vente de dévise </h5>
                                    </div>
                                    <div class="modal-body flex-grow-1">
                                                ...
                                                <div class="bs-stepper-content">
                                                    ...
                                                    <div id="stepper-facturation-modif" class="content" role="tabpanel" aria-labelledby="stepper-facturation-modif-trigger">
                                                        ...
                                                        <form id="form_facturation_modif" name="form_facturation_modif">
                                                            ...
                                                            <!--- DATE --->
                                                            <div class="mb-1">
                                                                <label class='form-label' for='date_vente_modif'>Date</label>
                                                                <input type='text' class='form-control' id='date_vente_modif' name='date_vente_modif' />
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div>
                                                                        <label class='form-label' for='taux_vente_modif'>Taux à la vente</label>
                                                                        <input type='text' class='form-control' id='taux_vente_modif' name='taux_vente_modif' placeholder="650" maxlength='75' />
                                                                    </div>
                                                            ...
                                                            <input type="hidden" id="id_vente_modif" name="id_vente_modif">
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <!--- TAUX VENTE --->
                                        <div class="mb-1">
                                            <label class='form-label' for='taux_vente_conversion'>Taux à la vente</label>
                                            <input type='text' class='form-control' id='taux_vente_conversion' name='taux_vente_conversion' placeholder="650" maxlength='75' />
        ...
        <?php include 'js/logiques/vente_devises_datatable.php' ?>
        <?php include 'js/logiques/vente_devises_logiques.php' ?>
