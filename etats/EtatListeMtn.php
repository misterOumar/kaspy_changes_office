...
class EtatListeMtn extends FPDF
{
    public $logoEtat;
    ...
    function Header()
    {
        if ($this->PageNo() == 1) {
            ...
            $this->Cell(0, 7, "Année de gestion : " . $this->annee, 0, 0, 'L');
            ...
            $this->Cell(100, 10, ' TRANSACTIONS MTN MONEY', 1, 0, 'C');
...
$pdf->SetTitle('Transactions MTN Money', 1);
