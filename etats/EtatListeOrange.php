 <?php
    ...
    if (isset($_POST['bt_orange'])) {
        ...
        $orange = orange::getAllBetween2Date($date_debut, $date_fin);
        //  var_dump($orange);
        ...
        if ($pdf->PageNo() == 1) {
            ...
            $pdf->Cell(150, 10, 'LISTE DES TRANSACTIONS ORANGE MONEY', 1, 0, 'C');
            // Décalage à droite
            $pdf->Cell(20);
            $pdf->Ln();
            $pdf->Cell(153);
        ...
        $pdf->SetTitle('TRANSACTIONS ORANGE MONNEY', 1);
        $pdf->Output();
