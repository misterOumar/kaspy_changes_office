...
class EtatListeOperation extends FPDF
{
    ...
    function BasicTable($data)
    {
        ...
        $this->Cell(34, 20, "COMPASENTIONS", 1, 0, 'C', true);
        ...
        $this->Ln();
           ...
           // // NOUVELLE LIGNE
        $this->Cell(30, 6, '1-aout', 1, 0, 'C');
        $this->Cell(27, 6,'kaspy', 1);

          // // SOUS EN-TETE  ENVOIS
        $this->Cell(29, 6,'S', 1, 0, 'C');
        $this->Cell(22, 6,'125 000 ', 1, 0, 'C');
        $this->Cell(21, 6,'', 1, 0, 'C');
        $this->Cell(22, 6,'', 1, 0, 'C');
        $this->Cell(20, 6,'123 310', 1, 0, 'C');

        // // SOUS EN-TETE  PAIEMENTS
        $this->Cell(28, 6,'', 1, 0, 'C');
        $this->Cell(28, 6,'', 1, 0, 'C');
        $this->Cell(20, 6,'412 310', 1, 0, 'C');
         // // COMPASSATION
        $this->Cell(34, 6,'-412 310', 1, 1, 'C');
