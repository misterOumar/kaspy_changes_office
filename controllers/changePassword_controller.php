...
$Liste_Users = null;
if (isset($_GET['page']) and !empty($_GET['page']) and $_GET['page'] === 'changePassword') {
...
if (isset($_POST['bt_enregistrer'])) {
    ...
    if ($succes) {
        ...
        if ($login_nom['users'] == $users) {
            ...
            if (Users::Ajouter($nom_prenom, $users, $hash_mot_pass, $type_compte, $sex, $adresse, $tel1, "", $email, "", $date_naissance, "", "", "", $fonction, "", "", "", $filename, 0, 1, 0, $hash_otp, $dt, $dt, $pc, $navigateur, $ip)) {
