...
function envoyerEmailForgot($email_client ,$lien_for_forgot ,$mail_objet) {
    ...
    //Email body
    $mail->Body = "<h2>Cliquez sur le lien pour réinitialisez votre mot de passe :</h2></br><p>" .  $lien_for_forgot . "</p>";
    //Add recipient
