...
function envoyerContratBail($nom_locataire ,$email_locataire ,$contrat, $mail_objet) {
    ...
    //Email subject
    // Pièce jointe (votre fichier PDF)
    $mail->addAttachment($contrat);
    ...
    //Email body
    $mail->Body = "<h2>Mr. ". $nom_locataire ." Voici ci joint votre contrat de bail:</h2></br>";
    //Add recipient
    $mail->addAddress($email_locataire); //Email of the person who will receive email
    //Finally send email
    if ($mail->send()) {
