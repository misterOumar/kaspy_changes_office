  ...
  $.ajax({
        ...
        success: function(result) {
          ...
          if (donnees['DroisAcces_ActifUser'] !== 'null') {
            ...
            // -------------------CONTRATS DE BAIL-------------------------------------------------
            //Creation
            if(parseInt(droits_access[0]['creation'], 10) == 0) {
              ...
              $("#bt_ajouter").removeClass("hidden");
                    ...
                    // Modification
             if(parseInt(droits_access[0]['modification'], 10) == 0) {
            ...
            //  //        suppression
             if(parseInt(droits_access[0]['suppression'], 10) == 0) {
            ...
            //  //        Duplicata
            //  if(intval(droits_access[0]['duplicata']) === 0) {
            //   $("#bt_ajouter").addClass("hidden");
            // }else{
            //   $("#bt_ajouter").removeClass("hidden");
            // }
            ...
            //  //        Visualisation
            //  if(intval(droits_access[0]['visualisation']) === 0) {
            //   $("#bt_ajouter").addClass("hidden");
            // }else{
            //   $("#bt_ajouter").removeClass("hidden");
            // }
            ...
            //  //        Exportation
             if(parseInt(droits_access[0]['exportation'], 10) == 0) {
