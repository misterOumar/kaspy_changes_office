  ...
  $.ajax({
        ...
        success: function(result) {
          ...
          if (donnees['DroisAcces_ActifUser'] !== 'null') {
            ...
            // -------------------DOSSIER ENTREPRISE-------------------------------------------------
            //Creation
            if(parseInt(droits_access[17]['creation'], 10) == 0) {
              ...
              $("#bt_ajouter").removeClass("hidden");
                    ...
                    // Modification
             if(parseInt(droits_access[17]['modification'], 10) == 0) {
            ...
            //  //        suppression
             if(parseInt(droits_access[17]['suppression'], 10) == 0) {
            ...
            //  //        Duplicata
            //  if(intval(droits_access[17]['duplicata']) === 0) {
            //   $("#bt_ajouter").addClass("hidden");
            // }else{
            //   $("#bt_ajouter").removeClass("hidden");
            // }
            ...
            //  //        Visualisation
            //  if(intval(droits_access[17]['visualisation']) === 0) {
            //   $("#bt_ajouter").addClass("hidden");
            // }else{
            //   $("#bt_ajouter").removeClass("hidden");
            // }
            ...
            //  //        Exportation
             if(parseInt(droits_access[17]['exportation'], 10) == 0) {
