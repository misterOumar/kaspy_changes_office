  ...
  $.ajax({
        ...
        success: function(result) {
          ...
          if (donnees['DroisAcces_ActifUser'] !== 'null') {
            ...
            // -------------------TYPE PIECE-------------------------------------------------
            //Creation
            if(parseInt(droits_access[12]['creation'], 10) == 0) {
              ...
              $("#bt_ajouter").removeClass("hidden");
                    ...
                    // Modification
             if(parseInt(droits_access[12]['modification'], 10) == 0) {
            ...
            //  //        suppression
             if(parseInt(droits_access[12]['suppression'], 10) == 0) {
              $(".link-delete-button").addClass("hidden");
            }else{
              $(".link-delete-button").removeClass("hidden");
            }

            //  //        Duplicata
            //  if(intval(droits_access[12]['duplicata']) === 0) {
            //   $("#bt_ajouter").addClass("hidden");
            // }else{
            //   $("#bt_ajouter").removeClass("hidden");
            // }
            ...
            //  //        Visualisation
            //  if(intval(droits_access[12]['visualisation']) === 0) {
            //   $("#bt_ajouter").addClass("hidden");
            // }else{
            //   $("#bt_ajouter").removeClass("hidden");
            // }
            ...
            //  //        Exportation
             if(parseInt(droits_access[12]['exportation'], 10) == 0) {
