...
$api_url = API_HOST . 'index.php?page=api_vente_devises';
?>
<script>
    $(function() {
        'use strict';
            ...
            data.map((champ_bd) => {
                ...
                dt_basic.row
                    .add({
                        ...
                        type_client: champ_bd.type_client,
                    ...
                    // ActionsVoulez vous vraiment supprimer ?
                    {
                        ...
                        render: function(data, type, full, meta) {
                            return (
                                ...
                                // imprimer
                                '</a>' +
                                '<a href="javascript:;" class="bt_imprimer" name="imprimerRecuVente" >' +
                            ...
                            $.ajax({
                                ...
                                success: function(result) {
                                    ...
                                    if (donnees['last_transaction'] !== 'null') {
                                        ...
                                        window.open('etats/RecuVenteDevises.php?idRecuImprimer=' + last_id, '_blank');
                                        ...
                                        dt_basic.row
                                            .add({
                                                ...
                                                id: last_id,
                                                dates: $new_date,
                                                type_client: $new_type,
                                                client: $new_nom_prenom,
        ...
        $('.datatables-basic tbody').on('click', '.item-edit', function() {
            ...
            $.ajax({
                ...
                success: function(result) {
                    var donnees = JSON.parse(result);
                    if (donnees['vente_devise'] !== 'null') {

                        let vente_devise = donnees['vente_devise']
                        ...
                        $('#date_vente_modif').val(vente_devise['dates']);
                        $('#devise_modif').val(vente_devise['devise']);
                        $('#mode_reglement_modif').val(vente_devise['mode_reglement']);
                        $('#quantite_modif').val(vente_devise['quantite']);
                        $('#taux_vente_modif').val(vente_devise['taux_vente']);
                        $('#remise_modif').val(vente_devise['remise']);
                        $('#total_brut_modif').val(vente_devise['montant_brut']);
                        $('#total_net_modif').val(vente_devise['montant_net']);
                        $('#observation_modif').val(vente_devise['observation']);
                        $('#id_vente_modif').val(vente_devise['id']);
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    if (donnees['vente_devise'] !== 'null') {
                        ...
                        let proprietes = donnees['vente_devise']
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    if (donnees['vente_devise'] !== 'null') {
                        ...
                        console.table(vente_devise);


                        $('#titre_modal').text("Détail de la vente de devise du " + vente_devise.date_creation)
                            ...
                            <table class="table table-bordered text-nowrap text-center table-hover">             
                                <tbody class="details">
                                    ...
                                    <tr>
                                        ...
                                        <th  class="text-start">${vente_devise.devise}</th>
                                    </tr>
                                    <tr>
                                        <td class="text-start" style="with:30%">Quantite</td>                                      
                                        <th  class="text-start">${vente_devise.quantite}</th>
                                    </tr>
                                    <tr>
                                        <td class="text-start" style="with:30%">Taux vente</td>                                      
                                        <th  class="text-start">${vente_devise.taux_vente}</th>
                                    </tr>
                                    <tr>
                                        <td class="text-start" style="with:30%">Montant Brut</td>                                      
                                        <th  class="text-start">${vente_devise.montant_brut}</th>
                                    </tr>
                                    <tr>
                                        <td class="text-start" style="with:30%">Remise</td>                                      
                                        <th  class="text-start">${vente_devise.remise}</th>
                                    </tr>
                                    <tr>
                                        <td class="text-start" style="with:30%">Montant Net</td>                                      
                                        <th  class="text-start">${vente_devise.montant_net}</th>
                                    </tr>
                                    <tr>
                                        <td class="text-start" style="with:30%">Montant en lettre</td>                                      
                                        <th  class="text-start">${vente_devise.montant_lettre}</th>
                                    </tr>
                                    <tr>
                                        <td class="text-start" style="with:30%">Mode de réglement</td>                                      
                                        <th  class="text-start">${vente_devise.mode_reglement}</th>
                                    </tr>
                                    <tr>
                                        <td class="text-start" style="with:30%">Observation</td>                                      
                                        <th  class="text-start">${vente_devise.observation}</th>
                                    </tr>
        ...
        $('.datatables-basic tbody').on('click', '.bt_imprimer', function() {
            ...
            window.open('etats/RecuVenteDevises.php?idRecuImprimer=' + idRecu, '_blank');
        });
        ...
        $('.datatables-basic tbody').on('click', '.delete-record', function() {
            ...
            Swal.fire({
                ...
                text: 'la vente de < ' + (dt_basic.row($(this).parents('tr')).data().client) + ' :' + (dt_basic.row($(this).parents('tr')).data().montant1) +
                ...
                if (result.value) {
                    Swal.fire({
                        ...
                        text: "'la vente de  " + (dt_basic.row($(that).parents('tr')).data().client) + " ' a été supprimée avec succès.",
